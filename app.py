...
def main():
    ...
    # this prevents loading data everytime user changes parameter
    @st.cache(persist=True)
    def load_data():
        data = pd.read_csv(r'C:\Users\jackw\Desktop\ML Web App\mushrooms.csv')
        label = LabelEncoder()
    ...
    st.sidebar.subheader("Chosoe Classifier")
    ...
    if classifier == 'Support Vector Machine (SVM)':
        ...
        metrics = st.sidebar.multiselect(
            "What metrics to plots?", ('Confusion Matrix', 'ROC Curve', 'Precision-Recall Curve'))
